/* Aşağıda global olarak tanımlanmış değişkenler bulunmaktadır, 
bunları değiştirmeyiniz. Açıklamaları takip ederek görevleri tamamlayın. */
...
/* (Oto test yok) Yukarıdaki KareninAlani fonksiyonunu kenar uzunluğu = 10 vererek aşağıda çalıştırıp, 
sonucu konsolda gözlemleyin (console.log)  */
...
/* (Oto test yok) Yukarıdaki CemberinCevresi fonksiyonunu yarıçap = 5 vererek aşağıda çalıştırıp, 
sonucu konsolda gözlemleyin (console.log)  */
...
- CemberinAlani fonksiyonunu kullanarak aşağıdaki yönergeleri uygulayın:
	...
	3. Çemberin alanı hesaplanacaktır (💡 İPUCU: Çemberin alanı = pi * yarıçapın karesi, 
  yarıçapın karesini bulmak için Javascript içinde tanımlı Math kütüphanesini kullanabilirsiniz. Math.pow(yaricap,2))
...
/* 	GÖREV 3:
  ...
  Bu diziyi kullanarak aşağıdakileri uygulayın:
    ...
    oluşturulup `tekraredensayilar` dizisine aktarılmasını istiyoruz. Örnek string: "{sayı} sayısı {tekrarSayisi} 
    ...
    Birinci döngüde hangi sayının kaç kere tekrar edildiğini tespit edip, 
    2. döngüde stringi oluşturup verilen diziye aktarmalısınız.
*/

/*  (oto test yok) sayilar dizisi içinde kaç adet sayı olduğunu konsola yazdırın */
// Commit kaplaması için yazdım
// Gene commit kaplasın diye yaptım gmpthp
// Daha fazla commit yapmak için boş yorum yaptım
...
const yeniBesYuz = [...besyuzdenkucuksayilar]
yeniBesYuz.sort((a, b)=> a - b)
siralisayilar = [...yeniBesYuz]
